      ...
      <div className="hidden lg:flex lg:w-1/2 bg-gradient-to-br from-slate-800 to-slate-900 p-12 items-center justify-center relative overflow-hidden">
        ...
        <div className="relative z-10 max-w-lg">
          ...
          <p className="text-lg text-slate-300 mb-8">
            Start your journey to financial freedom. Track, analyze, and optimize your spending with FinShield.
          </p>
          ...
          <div className="space-y-3 pt-2">
            <label className="flex items-start gap-3 cursor-pointer">
              ...
              <span className="text-sm text-slate-700">
                Send me updates about my finances and FinShield features
              </span>
            </label>
